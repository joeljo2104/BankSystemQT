...
#include<mainmenu.h>
#include<QtSql>
FundsTransfer2::FundsTransfer2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::FundsTransfer2)
{
    ui->setupUi(this);

}

void FundsTransfer2::showEvent( QShowEvent* event )
{
    ...
    else
    {
        ...
        QSqlQuery query;
        query.prepare("select FTrNo from CUSTOMER where AccountNo = :Account ");
...
FundsTransfer2::~FundsTransfer2()
{
    delete ui;
}

void FundsTransfer2::ReceiveAcc(int CurrentAccount)
{
    ui->AccountNo->setText(QString::number(CurrentAccount));
}

void FundsTransfer2::on_MainMenuB_clicked()
{
...
void FundsTransfer2::on_LogoutButton_clicked()
{
...
void FundsTransfer2::on_SuggestButton_clicked()
{
