...
#include<QSqlQuery>
#include<QtSql>
EducationLoan2::EducationLoan2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::EducationLoan2)
{
    ui->setupUi(this);
}

void EducationLoan2::showEvent( QShowEvent* event )
{
    ...
    {
        qDebug() << "DB Connected - EducationLoan2";
        QSqlQuery query;
        query.prepare("select ELAppNo from CUSTOMER where AccountNo = :Account ");
...
EducationLoan2::~EducationLoan2()
{
    delete ui;
}

void EducationLoan2::ReceiveAcc(int CurrentAccount)
{
    ui->AccountNo->setText(QString::number(CurrentAccount));
}

void EducationLoan2::on_MainMenuB_clicked()
{
...
void EducationLoan2::on_LogoutButton_clicked()
{
...
void EducationLoan2::on_SuggestButton_clicked()
{
