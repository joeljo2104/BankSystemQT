...
#include<QSqlQuery>
#include<QtSql>
HomeLoan2::HomeLoan2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::HomeLoan2)
{
    ui->setupUi(this);
...
void HomeLoan2::showEvent( QShowEvent* event )
{
    ...
    {
        qDebug() << "DB Connected - HomeLoan2";
        QSqlQuery query;
        query.prepare("select HLAppNo from CUSTOMER where AccountNo = :Account ");
...
void HomeLoan2::ReceiveAcc(int CurrentAccount)
{
    ui->AccountNo->setText(QString::number(CurrentAccount));
}

void HomeLoan2::on_MainMenuB_clicked()
{
...
void HomeLoan2::on_LogoutButton_clicked()
{
...
void HomeLoan2::on_SuggestButton_clicked()
{
