...
#include<QSqlQuery>
#include<QtSql>
MobileBill1::MobileBill1(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MobileBill1)
{
    ui->setupUi(this);
}

void MobileBill1::showEvent( QShowEvent* event )
{
...
MobileBill1::~MobileBill1()
{
    delete ui;
}

void MobileBill1::ReceiveAcc(int CurrentAccount)
{
    ui->AccountNo->setText(QString::number(CurrentAccount));
}

void MobileBill1::on_ConfirmB_clicked()
{
    ...
    else
    {
        ...
        if(query.exec())
        {
            ...
            if (Amount>Balance)
            {
            ...
            else if (ui->MobileBillT->text().isEmpty() || ui->MobileBillT->text().toInt() == 0){
                ...
                query.prepare("update CUSTOMER set Balance = :NewBalance, MBAmount = :Amount, MBDate = :Date, MBTrNo = :No where AccountNo = :Account ");
                query.bindValue(":Account",CurrentAccount);
                ...
                query.exec();
                QObject::connect(this,SIGNAL(SendAcc(int)),mobilebill2,SLOT(ReceiveAcc(int)));
        ...
        {
            qDebug() << "Mobile Bill Error";
        }
    }
    QSqlDatabase::removeDatabase("db");
}

void MobileBill1::on_LogoutButton_clicked()
{
...
void MobileBill1::on_BackButton_clicked()
{
...
void MobileBill1::on_SuggestButton_clicked()
{
